                ...
                <div className="container">
                    <div className="row">
                        ...
                        <ul className="link-list">
                            ...
                            <li><TranslatedLink id="footer__palaute" content_i18n_id="footer__palaute" link_i18n_id="/sivut/info/palaute/">Ilmoita virheestä tai anna palautetta</TranslatedLink><Translated tag="span" className="sr-only" id="footer__linkki_avautuu_uuteen_ikkunaan">Linkki avautuu uuteen ikkunaan</Translated></li>
                        </ul>
                    </div>
                </div>
            </footer>
